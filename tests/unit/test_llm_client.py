...
class TestLLMClient:
    ...
    @patch("havachat.utils.llm_client.instructor.patch")
    def test_client_initialization(self, mock_instructor_patch, mock_openai):
    ...
    @patch("langfuse.openai.OpenAI")
    @patch("havachat.utils.llm_client.instructor.patch")
    def test_successful_generate(self, mock_instructor_patch, mock_openai):
    ...
    @patch("langfuse.openai.OpenAI")
    @patch("havachat.utils.llm_client.instructor.patch")
    def test_generate_with_system_prompt(self, mock_instructor_patch, mock_openai):
    ...
    @patch("langfuse.openai.OpenAI")
    @patch("havachat.utils.llm_client.instructor.patch")
    @patch("havachat.utils.llm_client.time.sleep")  # Mock sleep to speed up test
    def test_retry_on_failure(self, mock_sleep, mock_instructor_patch, mock_openai):
    ...
    @patch("langfuse.openai.OpenAI")
    @patch("havachat.utils.llm_client.instructor.patch")
    @patch("havachat.utils.llm_client.time.sleep")
    def test_all_retries_fail(self, mock_sleep, mock_instructor_patch, mock_openai):
    ...
    @patch("langfuse.openai.OpenAI")
    @patch("havachat.utils.llm_client.instructor.patch")
    def test_generate_with_max_tokens(self, mock_instructor_patch, mock_openai):
    ...
    @patch("langfuse.openai.OpenAI")
    @patch("havachat.utils.llm_client.instructor.patch")
    def test_generate_with_custom_temperature(self, mock_instructor_patch, mock_openai):
