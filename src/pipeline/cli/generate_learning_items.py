...
from pipeline.generators.learning_item_generator import BaseLearningItemGenerator
...
from pipeline.utils.item_processing import post_process_learning_item
from pipeline.utils.llm_client import LLMClient
from pipeline.validators.schema import Category, LearningItem, LevelSystem
...
def load_learning_items_from_dir(source_dir: Path) -> List[LearningItem]:
    ...
    saved as JSON files by the enrichment pipeline.
