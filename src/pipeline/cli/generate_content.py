...
from pipeline.generators.content_generator import ContentGenerator
from pipeline.utils.llm_client import LLMClient
from pipeline.utils.usage_tracker import UsageTracker
...
def main():
    ...
    try:
        ...
        if num_items == 0:
            ...
            logger.error("Use: python -m src.pipeline.cli.generate_learning_items")
            sys.exit(1)
